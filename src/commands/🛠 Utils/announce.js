...
module.exports = {
    ...
    usage: "\n<announce #channel-name announcement test\n<announce #channel-name announcement test -ping <-- for ping",
    /** 
     * @param {Client} client 
    ...
    run: async (client, message, args) => {
        ...
        if (mention === true) channel.send(`@everyone, ${message.author} has made an announcement! Read below`);
