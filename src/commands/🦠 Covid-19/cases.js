...
module.exports = {
    name: 'cases',
    cooldown: 10000,
    usage: '\n<cases [today/td]\n<cases [today/td] [country name], <cases [yesterday/ytd]\ncases [yesterday/ytd] [country name]\n<cases [historic/hs]\n<cases [historic/hs] [number of days]\n<cases [historic/hs] [number of days] [country name]',
    description: "Shows the cases of Covid-19",
    /** 
    * @param {Client} client 
